// 4
// Find top-10 largest ASN in terms of connection size (Node degree distribution).
// It is finding the top 10 largest ASN in terms of connection size 
// (Node degree distribution) by using a HashMap to store the ASN and the number of connections
// and then sorting the HashMap by value and printing the top 10 largest ASN
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        try (BufferedReader br = new BufferedReader(fr)) {
            ...
            while((line = br.readLine()) != null) {
                ...
                if (list.containsKey(as1String)) {
                    list.put(as1String, list.get(as1String) + 1);
                } else {
                    list.put(as1String, 1);
                }
                if (list.containsKey(as2String)) {
                    list.put(as2String, list.get(as2String) + 1);
                } else {
                    list.put(as2String, 1);
                }
            }
